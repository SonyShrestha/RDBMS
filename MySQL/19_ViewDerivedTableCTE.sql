...
within the excution scope of a SELECT, INSERT, UPDATE, DELETE or CREATE VIEW 
...
-- Note: In Mysql, we should mention WITH RECURSIVE CTE, while in SQL WITH cte is sufficient
...
-- In MySQL, Update,Insert and Delete in CTE will raise an error
