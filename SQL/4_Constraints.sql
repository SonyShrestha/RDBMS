...
ALTER TABLE not_null_demo ALTER COLUMN id int NOT NULL;
...
-- Drop UNIQUE Index
ALTER TABLE unique_demo DROP INDEX name; -- SQL
ALTER TABLE unique_demo DROP CONSTRAINT unique_cons; -- MySQL
